...
public class MainActivity extends AppCompatActivity {
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, PRIMARY_CHANNEL_ID)
                ...
                .setContentTitle("This is your notification text.").setSmallIcon(R.drawable.ic_android)
    ...
    void setNotificationButtonState(Boolean isNotifyEnabled, Boolean isUpdatedEnabled, Boolean isCancelEnabled) {
        button_update.setEnabled(isUpdatedEnabled);
